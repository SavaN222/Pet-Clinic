      ...
      <c:if test = "${vetID == 1}">
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="create-vet.jsp">Kreiraj Radnika</a>
                        <c:url var="tempLink" value="VetControllerServlet">
		  	<c:param name="command" value="LIST" />
  		</c:url>
                        <a class="collapse-item" href="${tempLink}">Listaj Radnike</a>
                        </c:if>
                    </div>
                </div>
            </li>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                       ...
                       <a class="collapse-item" href="create-category.jsp">Add Category</a>
                        ...
                        <a class="collapse-item" href="utilities-animation.html">List Animal</a>
